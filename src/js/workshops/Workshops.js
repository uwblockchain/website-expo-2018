    ...
    <Grid style={{paddingBottom: "5em", paddingTop: "5em"}}>
      ...
      <Row style={{color: 'white', fontWeight: "600", paddingTop: "1.5em"}}>
        <Col xs={4} smOffset={5} xsOffset={1} >
          <h3 style={{marginLeft: "-3rem", fontWeight: "600" , paddingBottom: "0.5em"}}>TECHNOLOGY</h3>
        </Col>
      </Row>
      <Row>
        ...
        <Col sm={3} xs={4} style={{color: 'white'}}>
          ...
          <Row style={styleRows}><p>Identity on the <br /> Blockchain</p></Row>
          <Row style={styleRows}>Supply chain IoT <br /> conditions</Row>
        </Col>
      ...
      <Row style={{color: 'white', paddingTop: "1.5em", paddingBottom: "0.5em"}}>
        <Col xs={4} smOffset={5} xsOffset={1} >

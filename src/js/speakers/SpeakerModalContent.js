  ...
  <Row className="speaker-entry">
    ...
    <Col sm={8}>
      ...
      <div className="speaker-icons">
        {props.linkedIn !== undefined ? <a className="fab fa-linkedin" href={props.linkedIn}></a> : null}
        {props.email !== undefined ? <a className="fas fa-envelope" href={"mailto:" + props.email}></a> : null}
      </div>
    </Col>
  </Row>
);
